CREATE DATABASE  IF NOT EXISTS `azul_controle` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `azul_controle`;
...
CREATE TABLE `cor` (
  ...
  CONSTRAINT `fk_cor_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dimensao` (
  ...
  KEY `idx_id_produto_dimensao` (`id_produto`),
  CONSTRAINT `fk_dimensao_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`) ON DELETE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `produto` (
  ...
  `id_subtrib_produto` int(10) unsigned NOT NULL,
...
-- Dump completed on 2016-04-15  9:14:09
