CREATE DATABASE  IF NOT EXISTS `azul_controlev2` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `azul_controlev2`;
-- MySQL dump 10.13  Distrib 5.7.12, for Linux (x86_64)
--
-- Host: localhost    Database: azul_controlev2
-- ------------------------------------------------------
...
--
-- Table structure for table `categoria_atributo`
--
...
CREATE TABLE `categoria_atributo` (
  ...
  CONSTRAINT `fk_categoria_atributo_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `categoria_atributo`
--

LOCK TABLES `categoria_atributo` WRITE;
/*!40000 ALTER TABLE `categoria_atributo` DISABLE KEYS */;
INSERT INTO `categoria_atributo` VALUES (1,2,'COR'),(2,2,'DIMENSAO'),(3,2,'MODELO'),(4,2,'VOLTAGEM'),(5,2,'TAMANHO'),(6,2,'MARCA'),(7,2,'SERIE'),(8,2,'MOTOR');
...
CREATE TABLE `centro_custo` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '0 = ativo, 1 = inativo',
...
CREATE TABLE `compras_cab` (
  `id_compras_cab` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `numero_nfe_cab` varchar(50) DEFAULT NULL,
...
CREATE TABLE `compras_det` (
  `id_compras_det` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_compras_cab` int(11) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id_compras_det`),
  KEY `idx_nfe_cab` (`id_compras_cab`),
  ...
  CONSTRAINT `fk_nfedetalhe_nfecab` FOREIGN KEY (`id_compras_cab`) REFERENCES `compras_cab` (`id_compras_cab`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cor` (
  ...
  `descricao` varchar(45) DEFAULT NULL,
  `status` tinyint(1) DEFAULT '0' COMMENT '0=ativo,1=inativo,3=Indefinido',
  PRIMARY KEY (`id_cor`)
...
INSERT INTO `cor` VALUES (1,'PADRÃO',3),(7,'VERDE',0),(8,'AMARELO',0),(9,'AZUL',0),(10,'BRANCO',0),(11,'PRETO',0),(12,'VERMELHO',0);
...
CREATE TABLE `dimensao` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '0=ativo,1=inativo,3=indefinida',
...
INSERT INTO `email` VALUES (2,2,'p_email','p_site'),(3,3,'p_email','p_site'),(4,4,'p_email','p_site');
...
CREATE TABLE `empresa` (
  ...
  `sexo` tinyint(1) DEFAULT NULL COMMENT '1 = Masculino, 2 Feminino\n',
  `status` tinyint(1) DEFAULT '0' COMMENT '0 = ativo, 1 = inativado',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='empresa do sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `empresa` VALUES (2,1,'79.080.738/0001-78','p_razao_social','p_fantasia','p_contato','num_telefone','1','p_endereco','p_numeroen','p_complemento','p_bairro','p_cidade','UF','p_inscr_estadual','p_inscr_municipal','p_cep_','p_pais','p_e_mail','p_site',1,'2016-04-19 11:34:54','2016-04-22 14:45:45',1,0),(4,5,'29.080.738/0001-78','p_razao_social','p_fantasia','p_contato','num_telefone','1','p_endereco','p_numeroen','p_complemento','p_bairro','p_cidade','UF','p_inscr_estadual','p_inscr_municipal','p_cep_','p_pais','p_e_mail','p_site',1,'2016-04-19 11:45:31','2016-04-22 14:45:45',1,0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`empresa_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`empresa`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`empresa_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`empresa`
FOR EACH ROW
BEGIN
...
INSERT INTO `endereco` VALUES (2,2,'P_LOGRADOURO_ENDERECO','P_COMPLEMENTO_ENDERECO','p_numero_e','p_cep_end','P_BAIRRO_ENDERECO','P_CIDADE_ENDERECO','UF',1),(3,3,'P_LOGRADOURO_ENDERECO','P_COMPLEMENTO_ENDERECO','p_numero_e','p_cep_end','P_BAIRRO_ENDERECO','P_CIDADE_ENDERECO','UF',1),(4,4,'P_LOGRADOURO_ENDERECO','P_COMPLEMENTO_ENDERECO','p_numero','p_cep_end','P_BAIRRO_ENDERECO','P_CIDADE_ENDERECO','UF',1);
...
CREATE TABLE `estoque` (
  ...
  `id_referencia` int(11) unsigned NOT NULL,
  ...
  `data_saida_estoque` date DEFAULT NULL,
  ...
  KEY `fk_estoque_referencia_idx` (`id_referencia`),
  CONSTRAINT `fk_estoque_referencia` FOREIGN KEY (`id_referencia`) REFERENCES `referencia_produto` (`id_referencia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `estoque` VALUES (3,3,2,0.000,0.000,NULL,NULL,0.00,0.00,0.000,'2016-05-06 18:00:40',NULL,0),(4,4,2,0.000,0.000,NULL,NULL,0.00,0.00,0.000,'2016-05-06 18:10:55',NULL,0),(5,5,2,0.000,0.000,NULL,NULL,0.00,0.00,0.000,'2016-05-06 18:11:48',NULL,0),(6,6,2,0.000,0.000,NULL,NULL,0.00,0.00,0.000,'2016-05-06 18:14:08',NULL,0),(7,7,2,0.000,0.000,NULL,NULL,0.00,0.00,0.000,'2016-05-06 18:26:42',NULL,0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`estoque_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`estoque`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`estoque_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`estoque`
FOR EACH ROW
BEGIN
set new.data_alteracao = now();
END */;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`fisica_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`fisica`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`fisica_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`fisica`
FOR EACH ROW
BEGIN
...
INSERT INTO `grupo` VALUES (3,1,2,'P_DESCRICAO_GRUPO',0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`grupo_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`grupo`
FOR EACH ROW
BEGIN
...
INSERT INTO `juridica` VALUES (2,2,'P_CONTATO','2016-04-20 18:14:06',NULL,'p_inscrestadual','p_inscrmunicipal','2016-04-20'),(3,3,'P_CONTATO','2016-04-20 18:15:12',NULL,'p_inscrestadual','p_inscrmunicipal','2016-04-20'),(4,4,'P_CONTATO','2016-04-20 18:17:38',NULL,'p_inscrestadual','p_inscrmunicipal','2016-04-20');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`juridica_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`juridica`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`juridica_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`juridica`
FOR EACH ROW
BEGIN
...
INSERT INTO `local_estoque` VALUES (2,2,'MATRIZ 1','CENTRAL','0',0),(3,4,'MATRIZ 2','CENTRAL','0',0);
...
CREATE TABLE `lote_validade` (
  ...
  CONSTRAINT `fk_lote_estoque` FOREIGN KEY (`id_estoque`) REFERENCES `estoque` (`id_estoque`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`pagamento_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`pagamento`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`pagamento_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`pagamento`
FOR EACH ROW
BEGIN
...
CREATE TABLE `pessoa` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '0 - ativo\n1 - inativo',
...
INSERT INTO `pessoa` VALUES (2,2,'11111111000111','FORNECEDOR 2','P_NOMEFANTASIA',1,2,'2016-04-20 15:14:06',1,'2016-05-12 16:01:50','2016-04-20',1),(3,2,'21111111000111','FORNECEDOR 3','P_NOMEFANTASIA',1,2,'2016-04-20 15:15:12',1,'2016-05-12 16:01:50','2016-04-20',1),(4,2,'31111111000111','FORNECEDOR 4','P_NOMEFANTASIA',1,2,'2016-04-20 15:17:38',1,'2016-05-12 16:01:50','2016-04-20',1);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`pessoa_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`pessoa`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`pessoa_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`pessoa`
FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='cadastro de produtos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produto` VALUES (1,2,10,2,'P_DESCRICAO_PRODUTO','2016-05-03 19:57:36',NULL,0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`produto_BEFORE_INSERT`
BEFORE INSERT ON `azul_controlev2`.`produto`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `azul_controlev2`.`produto_BEFORE_UPDATE`
BEFORE UPDATE ON `azul_controlev2`.`produto`
FOR EACH ROW
BEGIN
...
--
-- Table structure for table `referencia_produto`
--

DROP TABLE IF EXISTS `referencia_produto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `referencia_produto` (
  ...
  `id_valor_atributos` text,
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 = ativo, 1 = inativo',
  PRIMARY KEY (`id_referencia`),
  UNIQUE KEY `un_eanempresa` (`id_empresa`,`cod_ean`),
  KEY `idx_idproduto` (`id_produto`),
  KEY `idx_cod_ean` (`cod_ean`),
  KEY `idx_empresa` (`id_empresa`),
  FULLTEXT KEY `fidx_atributos` (`id_valor_atributos`),
  CONSTRAINT `fk_referencia_empresa` FOREIGN KEY (`id_empresa`) REFERENCES `empresa` (`id_empresa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_referencia_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `referencia_produto`
--

LOCK TABLES `referencia_produto` WRITE;
/*!40000 ALTER TABLE `referencia_produto` DISABLE KEYS */;
INSERT INTO `referencia_produto` VALUES (3,1,2,'1111113','p_foto',0.000,'',0),(4,1,2,'1111111','p_foto',0.000,'',0),(5,1,2,'1111114','p_foto',0.000,'',0),(6,1,2,'1111112','p_foto',0.000,'',0),(7,1,2,'1111115','p_foto',0.000,'',0);
/*!40000 ALTER TABLE `referencia_produto` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `relacao` (
  `id_relacao` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_referencia` int(11) unsigned NOT NULL,
  `id_valor_atributo` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id_relacao`),
  KEY `fk_relacao_referencia_idx` (`id_referencia`),
  KEY `fk_relacao_valor_atributo_idx` (`id_valor_atributo`),
  CONSTRAINT `fk_relacao_referencia` FOREIGN KEY (`id_referencia`) REFERENCES `referencia_produto` (`id_referencia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_relacao_valor_atributo` FOREIGN KEY (`id_valor_atributo`) REFERENCES `valor_atributo` (`id_valor_atributo`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `relacao` VALUES (2,3,2),(3,3,6),(4,3,18),(5,3,25),(6,3,29),(7,3,32),(9,4,3),(10,4,6),(11,4,18),(12,4,25),(13,4,29),(14,4,32),(16,5,4),(17,5,6),(18,5,18),(19,5,25),(20,5,29),(21,5,32),(23,6,5),(24,6,6),(25,6,18),(26,6,25),(27,6,29),(28,6,32),(30,7,2),(31,7,6),(32,7,18),(33,7,25),(34,7,29),(35,7,32);
...
INSERT INTO `subgrupo` VALUES (2,3,1,'DESCRICAO SUBGRUPO',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='telefone dos clientes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `telefone` VALUES (2,2,'p_numerotelefone','1'),(3,3,'p_numerotelefone','1'),(4,4,'p_numerotelefone','1');
...
INSERT INTO `tipo_lancamento` VALUES (1,'COMPRA'),(2,'VENDA'),(3,'DEVOL.COMPRA'),(4,'DEVOL.VENDA');
...
CREATE TABLE `unidade` (
  `id_unidade` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `id_produto` int(11) unsigned NOT NULL,
  `descricao_unidade` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`id_unidade`),
  KEY `idx_id_produto` (`id_produto`),
  CONSTRAINT `fk_unidade_produto` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='cadastro de unidade dos produtos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `unidade` VALUES (1,1,'CX');
...
--
-- Table structure for table `valor_atributo`
--

DROP TABLE IF EXISTS `valor_atributo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `valor_atributo` (
  `id_valor_atributo` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_categoria` int(10) unsigned NOT NULL,
  `valor_atributo` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_valor_atributo`),
  KEY `fk_valor_atributo_categoria_idx` (`id_categoria`),
  CONSTRAINT `fk_valor_atributo_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categoria_atributo` (`id_categoria`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `valor_atributo`
--

LOCK TABLES `valor_atributo` WRITE;
/*!40000 ALTER TABLE `valor_atributo` DISABLE KEYS */;
INSERT INTO `valor_atributo` VALUES (2,1,'BRANCA'),(3,1,'AZUL'),(4,1,'VERDE'),(5,1,'AMARELO'),(6,2,'15x15'),(7,2,'10x10x20'),(8,2,'20X20X10'),(9,3,'DRW'),(10,3,'MWM'),(11,3,'XXWX'),(18,6,'VOLKSWAGEM'),(19,6,'FORD'),(20,6,'FIAT'),(21,6,'CHEVROLET'),(22,6,'SCANIA'),(23,6,'VOLVO'),(24,6,'IVECO'),(25,3,'GOL'),(26,3,'FOX'),(27,3,'VOYAGE'),(28,3,'GOLF'),(29,7,'G5'),(30,7,'CROSS'),(31,7,'TREND'),(32,8,'1.8'),(33,8,'1.0'),(34,8,'1.6'),(35,8,'2.0');
...
CREATE TABLE `venda_cab` (
  ...
  `xml` text,
  `status` tinyint(1) DEFAULT NULL COMMENT '0=ativo,1=inativo',
...
CREATE TABLE `voltagem` (
  `id_voltagem` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_referencia` int(11) unsigned NOT NULL,
  `descricao` varchar(45) DEFAULT NULL,
...
--
-- Dumping events for database 'azul_controlev2'
--

--
-- Dumping routines for database 'azul_controlev2'
--
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `fun_SPLIT_STRING` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `fun_SPLIT_STRING`( s VARCHAR(1024) , del CHAR(1) , i INT) RETURNS int(11)
    DETERMINISTIC
BEGIN
        ...
        IF i > n THEN
            RETURN NULL ;
        ELSE
            RETURN CONVERT(SUBSTRING_INDEX(SUBSTRING_INDEX(s, del, i) , del , -1 ), unsigned) ;
        END IF;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `classCompraCab_proc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `classCompraCab_proc`(
in p_opt               int(1),
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `classGrupo_proc`(
  in p_opt int(1),
  in p_id_empresa int(11),
...
SELECT `empresa`.`id_empresa` into d_id_empresa
FROM `empresa`
where `empresa`.`id_empresa`=p_id_empresa;

if (d_id_empresa = 0 or d_id_empresa is null) then
   select 'Empresa não Cadastrada';
   LEAVE main;
end if;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `classRefProduto_proc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `classRefProduto_proc`(
in p_opt               int(1),
in p_id_valor_atributo text
)
main: BEGIN
   ...
   while d_limite = 0 do
      ...
      if (d_varid = 0 or d_varid is null) then
		 ...
		 if (d_varid != 999) then
            SELECT `categoria_atributo`.`descricao` INTO d_descricao_cat
              FROM `valor_atributo`
   ...
   select * from tmp_itens_atributo;
   COMMIT;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `classRefProduto_v2proc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `classRefProduto_v2proc`(
in p_opt               int(1),
in p_id_referencia int(11),
in p_id_produto    int(11),
in p_cod_ean       varchar(14),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `classRefProduto_v3proc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `classRefProduto_v3proc`(
in p_opt               int(1),
in p_id_valor_atributo text
)
main: BEGIN
...
-- fim
   ...
   while d_limite = 0 do
      set d_varid=0;
      select fun_SPLIT_STRING(p_id_valor_atributo,'|',d_index) into d_varid;
      select d_contador,code,d_varid;
      IF code = '00000' THEN
         if (d_varid = 0 or d_varid is null) then
             set d_limite = 99;
		 else
...
-- Dump completed on 2016-05-17 17:58:05
